...
6.  When prompted, select a **subscription** to create the resources and select the region of your resource group. We can use WestUS if your resource gorup is created in Westus region.
