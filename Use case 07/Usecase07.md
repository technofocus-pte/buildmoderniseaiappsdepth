...
1.  Open a web browser and navigate to
    the \`\`https:\\\portal.azure.com/\`\`and sign in with your Azure
    credentails.
...
1.  On the sidebar, select **Server Parameters**.Search for
    the **azure.extensions** parameter.

![A screenshot of a computer Description automatically
generated](./media/image21.png)

2.  Select extensions **Vector** and **AZURE_AI** if already not
    selected.
