...
> ![Screenshot](./media/image2.png){width="4.117361111111111in"
> height="3.290277777777778in"}
>
> ![Screenshot](./media/image3.png){width="6.5in"
...
>
> ![](./media/image5.png){width="6.5in" height="4.460416666666666in"}
...
generated](./media/image8.png){width="6.042190507436571in"
...
>
> ![Screenshot](./media/image9.png){width="5.913888888888889in"
...
> ![Screenshot](./media/image11.png){width="5.209722222222222in"
> height="6.574305555555555in"}
>
...
> ![](./media/image15.png){width="6.5in" height="4.371527777777778in"}
...
generated](./media/image16.png){width="4.158694225721785in"
...
> notice **\-\--\>** Using cache for layers that haven\'t changed. If
> your not making app changes (before rerunning the **docker
> build** command), then you\'ll notice all cached layers as the
> binaries are untouched and can be sourced from Docker cache). This is
> an important takeaway when optimizing your container images and the
...
2.  Docker run is the command used to run a container image. The -p
    ...
    port before the colon) traffic to the container at runtime (the
    second port after the colon). Remember from the Dockerfile that the
    Tomcat app server is listening for HTTP traffic on port 8080 hence
    that is the container port that needs to be exposed. Lastly the
    image tag flightbookingsystemsample is needed to instruct Docker of
    what image to run. Run the following command in your CLI:
...
>
> ![Screenshot](./media/image22.png){width="6.5in" height="3.5in"}
...
> ![Screenshot](./media/image23.png){width="6.5in" height="3.48125in"}
...
> ![](./media/image25.png){width="6.5in" height="3.113888888888889in"}
...
> app: flightbookingsystemsample
>
> ![](./media/image33.png){width="6.5in" height="5.0680555555555555in"}
...
generated](./media/image35.png){width="6.5in" height="0.85in"}
...
> ![A black screen with white text Description automatically
> generated](./media/image36.png){width="6.5in" height="1.15in"}
...
> ![](./media/image37.png){width="6.5in" height="2.2805555555555554in"}
>
...
> ![Screenshot](./media/image41.png){width="6.4875in"
> height="3.876388888888889in"}

2.  Click on the cloud resource group .

> ![](./media/image42.png){width="6.492361111111111in"
> height="3.2423611111111112in"}

3.  Select the resources created for this lab and click on **Delete**

> ![](./media/image43.png){width="6.5in" height="2.386111111111111in"}

4.  Enter **delete** in the text box and click on **Delete** button.

![](./media/image44.png){width="6.492361111111111in" height="4.39375in"}

5.  Confirm the deletion by clicking on the **delete** button on the
    confirmation window.

![A screenshot of a computer Description automatically
generated](./media/image45.png){width="5.617153324584427in"
height="4.575396981627296in"}

![](./media/image46.png){width="6.5in" height="1.9361111111111111in"}
