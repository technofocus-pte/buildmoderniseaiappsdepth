...
1.  通过 +++\*\*[https://portal.azure.com\*\*+++]() 登录到 Azure
    门户，然后使用 Azure 登录凭据从Resources选项卡登录。
...
14. 打开 **路径 C：\LabFiles\Build a Chat bot\Labs\deploy 中的
    ...
    <+++dg@lab.LabInstance.Id>+++。在第 **74** 行，将版本更新为
    +++**0125**+++。
